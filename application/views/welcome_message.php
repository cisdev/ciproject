...
<head>
    ...
    <meta name="description" content="dev sharma ci website" />
    <meta name="keywords" content="dev sharma devd" />
	...
	<title>Home-Devsharma</title>
            ...
            <link rel="apple-touch-icon-precomposed" href="<?php echo IMG_PATH ?>icon.png" />
                  ...
                  <div class="flexslider"><!--http://flex.madebymufffin.com/-->
                      ...
                      Sie haben Javascript deaktiviert. Diese Slideshow wird nur vollständig angezeigt, wenn Sie Javascript aktivieren.</noscript> 
  						...
  						<ul class="slides">
                            	...
                            	<li>
                        				<a href="http://www."><img src="<?php echo IMG_PATH ?>img1.jpg" alt="demo-image" />
                                        <p class="flex-caption">This is a describing caption for your image</p>
                                        </a>
                                </li>
                                <li>
                        				<a href="http://www."><img src="<?php echo IMG_PATH ?>img2.jpg" alt="demo-image" />
                                        <p class="flex-caption">Of course you can also remove it, if you want</p>
                                        </a>
                                </li> 
                              
                                <li>                                  
                        				<a href="http://www."><img src="<?php echo IMG_PATH ?>img3.jpg" alt="demo-image" />
                                        <!-- delete the p if you don´t want to use captions for the images-->
                                        </a>
                                </li>
                               
                                <li>                                
                        				<a href="http://www."><img src="<?php echo IMG_PATH ?>img4.jpg" alt="demo-image" />
                                ...
                                <li>
                        				...
                        				<a href="http://www."><img src="<?php echo IMG_PATH ?>img5.jpg" alt="demo-image" />
...
<!--========================================================================== Content Part 3 =====================================================================================-->       
		<div class="wrapper">   
                    ...
                    <div class="grids">
                        <div class="grid-4 grid">
                            <img src="<?php echo IMG_PATH ?>small-img1.jpg" alt="demo-image">
                        </div>
                        ...
                        <div class="grid-4 grid">
                        <img src="<?php echo IMG_PATH ?>small-img3.jpg" alt="demo-image"> 
                        </div>
	...
	<!--===================================================  second row of Content Part 3 ================================================-->         
        ...
        <div class="wrapper">   
                    ...
                    <div class="grids">
                        <div class="grid-4 grid">
                            <img src="<?php echo IMG_PATH ?>small-img2.jpg" alt="demo-image">
                        </div>
                        ...
                        <div class="grid-4 grid">
                        	<img src="<?php echo IMG_PATH ?>small-img4.jpg" alt="demo-image">    
                        </div>
